 ...
 *
 */
public abstract class AbstractSnapshot extends ResourceSupport implements Serializable {
	...
	public AbstractSnapshot(Long entityId) {
    ...
    public void setEntityId(Long key) {
        this.entityId = key;
    }
     ...
     * @return
     */
    protected boolean isNull(Long businessKey) {
